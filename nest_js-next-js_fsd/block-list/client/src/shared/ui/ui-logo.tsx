...
const Shield = ({ className }: { className: string }) => {
  return (
    ...
    >
      ...
      <path
        d="M32 60.8q-.45 0-.9-.3C30.4 60 12.6 48.2 10 32.3C7.9 19 12.7 9.1 12.9 8.6c.3-.6 1-1 1.7-.9c0 0 2.3.3 4.9.3c1.5 0 2.7-.1 3.7-.3c3.8-.7 7.7-4.1 7.7-4.1c.6-.5 1.5-.5 2.1 0c0 0 4 3.4 7.7 4.2c1 .2 2.3.3 3.7.3c2.6 0 4.8-.3 4.9-.3c.7-.1 1.4.3 1.7.9c.2.4 5 10.4 2.9 23.6c-2.5 15.9-20.3 27.7-21 28.2q-.45.3-.9.3M15.4 11.2C14.3 14 11.7 22 13.3 31.8c2 12.5 15.2 22.8 18.7 25.4c3.6-2.6 16.7-12.9 18.7-25.4c1.6-9.8-1-17.8-2.1-20.6c-1 .1-2.5.2-4.1.2c-1.7 0-3.2-.1-4.4-.4c-3.3-.7-6.5-2.8-8.1-4c-1.6 1.2-4.8 3.4-8.1 4.1c-1.2.2-2.7.4-4.4.4c-1.6-.1-3.1-.2-4.1-.3"
        opacity=".2"
      />
      <g fill="#b0bdc6">
      ...
      <path
        fill="#89969b"
        d="M50.9 8.6c-.4 0-.8-.2-1.1-.5c.1.6.5 1 1.1 1s1-.4 1.1-1c-.3.3-.7.5-1.1.5"
      />
      <circle cx="54.3" cy="21.2" r="1.4" fill="#b0bdc6" />
      <circle cx="54.3" cy="21.2" r="1.1" fill="#dfe9ef" />
      <path
        fill="#89969b"
        d="M54.3 21.8c-.4 0-.8-.2-1.1-.5c.1.6.5 1 1.1 1s1-.4 1.1-1c-.3.3-.7.5-1.1.5"
      />
      ...
      <path
        fill="#89969b"
        d="M32 61.3c-.4 0-.8-.2-1.1-.5c.1.6.5 1 1.1 1s1-.4 1.1-1c-.3.3-.7.5-1.1.5"
      />
      <circle cx="20" cy="50.5" r="1.4" fill="#b0bdc6" />
      <circle cx="20" cy="50.5" r="1.1" fill="#dfe9ef" />
      <path
        fill="#89969b"
        d="M20 51c-.4 0-.8-.2-1.1-.5c.1.6.5 1 1.1 1s1-.4 1.1-1c-.3.4-.7.5-1.1.5"
      />
      <circle cx="11.7" cy="37.7" r="1.4" fill="#b0bdc6" />
      <circle cx="11.7" cy="37.7" r="1.1" fill="#dfe9ef" />
      <path
        fill="#89969b"
        d="M11.7 38.2c-.4 0-.8-.2-1.1-.5c.1.6.5 1 1.1 1s1-.4 1.1-1c-.3.3-.7.5-1.1.5"
      />
      <circle cx="9.7" cy="21.2" r="1.4" fill="#b0bdc6" />
      <circle cx="9.7" cy="21.2" r="1.1" fill="#dfe9ef" />
      <path
        fill="#89969b"
        d="M9.7 21.8c-.4 0-.8-.2-1.1-.5c.1.6.5 1 1.1 1s1-.4 1.1-1c-.3.3-.7.5-1.1.5"
      />
      <circle cx="13.1" cy="8" r="1.4" fill="#b0bdc6" />
      <circle cx="13.1" cy="8" r="1.1" fill="#dfe9ef" />
      <path
        fill="#89969b"
        d="M13.1 8.6c-.4 0-.8-.2-1.1-.5c.1.6.5 1 1.1 1s1-.4 1.1-1c-.3.3-.7.5-1.1.5"
      />
    </svg>
  );
};
